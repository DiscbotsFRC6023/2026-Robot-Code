...
public class PrepareShotCommand extends Command {
    ...
    static {
        distanceToShotMap.put(Inches.of(52.0), new Shot(1500, 0.19));
        distanceToShotMap.put(Inches.of(114.4), new Shot(1600, 0.40));
        distanceToShotMap.put(Inches.of(165.5), new Shot(1700, 0.48));
    }
    ...
    public void execute() {
        ...
        hood.setNormalizedPosition(shot.hoodPosition);
